...
class UpdateVoiceRequest(_message.Message):
    __slots__ = ("request_id", "voice_id", "metadata")
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    VOICE_ID_FIELD_NUMBER: _ClassVar[int]
    METADATA_FIELD_NUMBER: _ClassVar[int]
    request_id: str
    voice_id: str
    metadata: VoiceMetadata
    def __init__(self, request_id: _Optional[str] = ..., voice_id: _Optional[str] = ..., metadata: _Optional[_Union[VoiceMetadata, _Mapping]] = ...) -> None: ...
